...
public class LockHandler extends ExistingEntityHandler {
   ...
   private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(LockHandler.class);
    ...
    protected void respondWithToken(LockToken tok, Response response) {
        ...
        writer.newLine();        
        if( tok.info == null ) {
            log.warn("null infor on token. client's might not be able to parse the response");
        } else {
