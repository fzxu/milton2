...
class Utils {
    ...
    static void processResultCode(int result, String href) throws RedirectException, BadRequestException, Unauthorized, NotFoundException, MethodNotAllowedException, GenericHttpException, InternalServerError {
